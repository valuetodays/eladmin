...
dc_file=/root/workbench_dir/git-repo/valuetodays-dockers/eladmin-quarkus/docker-compose.yml
# print result
docker compose -f ${dc_file} ps
log_text=$(docker compose -f ${dc_file} ps | grep 'eladmin-system-quarkus')
